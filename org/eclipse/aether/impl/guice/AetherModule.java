...
public class AetherModule extends AbstractModule {
  protected void configure() {
    ...
    bind(RepositoryLayoutFactory.class).annotatedWith((Annotation)Names.named("maven2"))
    ...
    bind(LocalRepositoryManagerFactory.class).annotatedWith((Annotation)Names.named("simple"))
      .to(SimpleLocalRepositoryManagerFactory.class).in(Singleton.class);
    bind(LocalRepositoryManagerFactory.class).annotatedWith((Annotation)Names.named("enhanced"))
      .to(EnhancedLocalRepositoryManagerFactory.class).in(Singleton.class);
    install((Module)new Slf4jModule());
  }
  
  @Provides
  @Singleton
  Set<LocalRepositoryManagerFactory> provideLocalRepositoryManagerFactories(@Named("simple") LocalRepositoryManagerFactory simple, @Named("enhanced") LocalRepositoryManagerFactory enhanced) {
