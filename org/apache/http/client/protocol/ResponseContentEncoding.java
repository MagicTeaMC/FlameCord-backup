...
public class ResponseContentEncoding implements HttpResponseInterceptor {
  ...
  public ResponseContentEncoding(Lookup<InputStreamFactory> decoderRegistry, boolean ignoreUnknown) {
    this.decoderRegistry = (decoderRegistry != null) ? decoderRegistry : (Lookup<InputStreamFactory>)RegistryBuilder.create().register("gzip", GZIPInputStreamFactory.getInstance()).register("x-gzip", GZIPInputStreamFactory.getInstance()).register("deflate", DeflateInputStreamFactory.getInstance()).build();
