...
public final class HttpClientParamConfig {
  ...
  public static RequestConfig getRequestConfig(HttpParams params, RequestConfig defaultConfig) {
    ...
    Collection<String> targetAuthPrefs = (Collection<String>)params.getParameter("http.auth.target-scheme-pref");
    if (targetAuthPrefs != null)
      builder.setTargetPreferredAuthSchemes(targetAuthPrefs); 
    Collection<String> proxySuthPrefs = (Collection<String>)params.getParameter("http.auth.proxy-scheme-pref");
