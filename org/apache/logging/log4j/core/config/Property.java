...
public final class Property {
  ...
  public String evaluate(StrSubstitutor substitutor) {
    return this.valueNeedsLookup ? substitutor
      
      .replace(PropertiesPlugin.unescape(getRawValue())) : 
      getValue();
  }
  ...
  @PluginFactory
  public static Property createProperty(@PluginAttribute("name") String name, @PluginValue(value = "value", substitute = false) String rawValue, @PluginConfiguration Configuration configuration) {
    return createProperty(name, rawValue, (configuration == null) ? rawValue : configuration
        
        .getStrSubstitutor().replace(rawValue));
  }
