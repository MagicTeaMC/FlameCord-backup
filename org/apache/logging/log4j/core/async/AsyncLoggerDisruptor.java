...
class AsyncLoggerDisruptor extends AbstractLifeCycle {
  ...
  AsyncLoggerDisruptor(String contextName, Supplier<AsyncWaitStrategyFactory> waitStrategyFactorySupplier) {
    ...
    this.waitStrategyFactorySupplier = Objects.<Supplier<AsyncWaitStrategyFactory>>requireNonNull(waitStrategyFactorySupplier, "waitStrategyFactorySupplier");
  }
  ...
  public synchronized void start() {
    ...
    this.disruptor = new Disruptor(RingBufferLogEvent.FACTORY, this.ringBufferSize, (ThreadFactory)log4jThreadFactory, ProducerType.MULTI, this.waitStrategy);
    ...
    LOGGER.debug("[{}] Starting AsyncLogger disruptor for this context with ringbufferSize={}, waitStrategy={}, exceptionHandler={}...", this.contextName, 
        Integer.valueOf(this.disruptor.getRingBuffer().getBufferSize()), this.waitStrategy
