...
public abstract class NameAbbreviator {
  ...
  private static final class PatternAbbreviatorFragment {
    ...
    public String toString() {
      return String.format("%s[charCount=%s, ellipsis=%s]", new Object[] { getClass().getSimpleName(), Integer.valueOf(this.charCount), Integer.toHexString(this.ellipsis) });
    }
  }
  ...
  private static final class PatternAbbreviator extends NameAbbreviator {
    ...
    public String toString() {
      return String.format("%s[fragments=%s]", new Object[] { getClass().getSimpleName(), Arrays.toString((Object[])this.fragments) });
    }
  }
}
