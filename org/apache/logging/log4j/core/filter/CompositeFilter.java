...
public final class CompositeFilter extends AbstractLifeCycle implements Iterable<Filter>, Filter {
  ...
  public CompositeFilter addFilter(Filter filter) {
    ...
    if (filter instanceof CompositeFilter) {
      ...
      Filter[] arrayOfFilter = Arrays.<Filter>copyOf(this.filters, this.filters.length + compositeFilter.size());
      System.arraycopy(compositeFilter.filters, 0, arrayOfFilter, this.filters.length, compositeFilter.filters.length);
  ...
  public CompositeFilter removeFilter(Filter filter) {
    ...
    return new CompositeFilter(filterList.<Filter>toArray(Filter.EMPTY_ARRAY));
  }
