    ...
    if (factory == null) {
      ...
      if (ProviderUtil.hasProviders()) {
        for (Provider provider : ProviderUtil.getProviders()) {
          ...
          if (factoryClass != null)
            try {
              ...
              LOGGER.error("Unable to create class {} specified in provider URL {}", factoryClass
                  .getName(), provider.getUrl(), e);
            }  
        } 
        if (factories.isEmpty()) {
          ...
          factory = (LoggerContextFactory)SimpleLoggerContextFactory.INSTANCE;
