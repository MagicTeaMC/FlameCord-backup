...
public final class StatusLogger extends AbstractLogger {
  ...
  static final boolean DEBUG_ENABLED = PropertiesUtil.getProperties()
    .getBooleanProperty("log4j2.debug", false, true);
  
  private static final StatusLogger STATUS_LOGGER = new StatusLogger(StatusLogger.class
      .getName(), (MessageFactory)ParameterizedNoReferenceMessageFactory.INSTANCE, 
