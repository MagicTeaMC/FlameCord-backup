...
public class ReflectionToStringBuilder extends ToStringBuilder {
  ...
  protected boolean accept(Field field) {
    ...
    if (this.excludeFieldNames != null && 
      Arrays.binarySearch((Object[])this.excludeFieldNames, field.getName()) >= 0)
      return false; 
    return !field.isAnnotationPresent((Class)ToStringExclude.class);
  }
      ...
      if (accept(field))
        try {
          ...
          if (!this.excludeNullValues || fieldValue != null)
            append(fieldName, fieldValue, !field.isAnnotationPresent((Class)ToStringSummary.class)); 
