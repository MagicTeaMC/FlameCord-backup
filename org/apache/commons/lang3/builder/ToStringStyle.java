...
public abstract class ToStringStyle implements Serializable {
  ...
  private static final class JsonToStringStyle extends ToStringStyle {
    ...
    private boolean isJsonArray(String valueAsString) {
      return (valueAsString.startsWith(getArrayStart()) && valueAsString
        .endsWith(getArrayEnd()));
    }
    
    private boolean isJsonObject(String valueAsString) {
      return (valueAsString.startsWith(getContentStart()) && valueAsString
        .endsWith(getContentEnd()));
    }
