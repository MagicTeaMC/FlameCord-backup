...
public class StringUtils {
  ...
  public static String joinWith(String separator, Object... objects) {
    ...
    Iterator<Object> iterator = Arrays.<Object>asList(objects).iterator();
    while (iterator.hasNext()) {
  ...
  private static String replaceEach(String text, String[] searchList, String[] replacementList, boolean repeat, int timeToLive) {
    ...
    while (textIndex != -1) {
      ...
      for (m = 0; m < searchLength; m++) {
        if (!noMoreMatchesForReplIndex[m] && searchList[m] != null && 
          !searchList[m].isEmpty() && replacementList[m] != null) {
  ...
  public static String overlay(String str, String overlay, int start, int end) {
    ...
    return str.substring(0, start) + overlay + str
  ...
  public static String capitalize(String str) {
    ...
    int inOffset;
    for (inOffset = Character.charCount(firstCodepoint); inOffset < strLen; ) {
  ...
  public static String swapCase(String str) {
    ...
    int i;
    for (i = 0; i < strLen; ) {
      int newCodePoint, oldCodepoint = str.codePointAt(i);
  ...
  public static String abbreviateMiddle(String str, String middle, int length) {
    ...
    return str.substring(0, startOffset) + middle + str
