...
public class AnnotationUtils {
      ...
      try {
        ...
        if (value == null)
          throw new IllegalStateException(
              String.format("Annotation method %s returned null", new Object[] { m })); 
  ...
  public static boolean isValidAnnotationMemberType(Class<?> type) {
    ...
    return (type.isPrimitive() || type.isEnum() || type.isAnnotation() || String.class
      .equals(type) || Class.class.equals(type));
  }
