...
public class MethodProperty extends GenericProperty {
  ...
  public void set(Object object, Object value) throws Exception {
    if (!this.writable)
      throw new YAMLException("No writable property '" + 
          getName() + "' on class: " + object.getClass().getName()); 
  ...
  public List<Annotation> getAnnotations() {
    ...
    if (isReadable() && isWritable()) {
      annotations = ArrayUtils.toUnmodifiableCompositeList((Object[])this.property
          .getReadMethod().getAnnotations(), (Object[])this.property.getWriteMethod().getAnnotations());
    } else if (isReadable()) {
