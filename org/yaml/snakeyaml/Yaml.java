...
public class Yaml {
  ...
  public Yaml(BaseConstructor constructor, Representer representer, DumperOptions dumperOptions, LoaderOptions loadingConfig, Resolver resolver) {
    ...
    if (!dumperOptions.getIndentWithIndicator() && dumperOptions
      .getIndent() <= dumperOptions.getIndicatorIndent())
  ...
  public Iterable<Node> composeAll(Reader yaml) {
    final Composer composer = new Composer((Parser)new ParserImpl(new StreamReader(yaml), this.loadingConfig), this.resolver, this.loadingConfig);
