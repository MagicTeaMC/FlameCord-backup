    ...
    AccessController.doPrivileged(new PrivilegedAction<Void>() {
          public Void run() {
            try {
              ...
              Class<Provider> bcProviderClass = (Class)Class.forName("org.bouncycastle.jce.provider.BouncyCastleProvider", true, classLoader);
              Class.forName("org.bouncycastle.openssl.PEMParser", true, classLoader);
              BouncyCastlePemReader.bcProvider = bcProviderClass.getConstructor(new Class[0]).newInstance(new Object[0]);
