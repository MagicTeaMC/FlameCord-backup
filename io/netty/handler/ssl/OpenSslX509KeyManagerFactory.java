...
public final class OpenSslX509KeyManagerFactory extends KeyManagerFactory {
  ...
  private static final class OpenSslKeyManagerFactorySpi extends KeyManagerFactorySpi {
    ...
    protected synchronized void engineInit(KeyStore keyStore, char[] chars) throws KeyStoreException, NoSuchAlgorithmException, UnrecoverableKeyException {
      ...
      this
        .providerFactory = new ProviderFactory(ReferenceCountedOpenSslContext.chooseX509KeyManager(this.kmf.getKeyManagers()), password(chars), Collections.list(keyStore.aliases()));
    }
    ...
    protected KeyManager[] engineGetKeyManagers() {
      ...
      return new KeyManager[] { ProviderFactory.access$000(providerFactory) };
    }
  ...
  private static final class OpenSslKeyStore extends KeyStore {
    private OpenSslKeyStore(X509Certificate[] certificateChain, boolean keyless) {
      super(new KeyStoreSpi(keyless, certificateChain) {
            ...
            public Certificate[] engineGetCertificateChain(String alias) {
              return engineContainsAlias(alias) ? (Certificate[])certificateChain.clone() : null;
            }
            ...
            public Date engineGetCreationDate(String alias) {
              return engineContainsAlias(alias) ? this.creationDate : null;
            }
