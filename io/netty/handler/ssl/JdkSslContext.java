...
public class JdkSslContext extends SslContext {
  ...
  private static final class Defaults {
    ...
    void init() {
      ...
      List<String> ciphersNonTLSv13 = new ArrayList<String>(this.defaultCiphers);
      ciphersNonTLSv13.removeAll(Arrays.asList((Object[])SslUtils.DEFAULT_TLSV13_CIPHER_SUITES));
      this.defaultCiphersNonTLSv13 = Collections.unmodifiableList(ciphersNonTLSv13);
      Set<String> suppertedCiphersNonTLSv13 = new LinkedHashSet<String>(this.supportedCiphers);
      suppertedCiphersNonTLSv13.removeAll(Arrays.asList((Object[])SslUtils.DEFAULT_TLSV13_CIPHER_SUITES));
  ...
  private static String[] defaultProtocols(SSLContext context, SSLEngine engine) {
    ...
    if (!protocols.isEmpty())
      return protocols.<String>toArray(EmptyArrays.EMPTY_STRINGS); 
