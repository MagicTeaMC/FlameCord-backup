...
public class WebSocketServerProtocolHandler extends WebSocketProtocolHandler {
  public enum ServerHandshakeStateEvent {
    HANDSHAKE_COMPLETE, HANDSHAKE_TIMEOUT;
  }
  ...
  public void handlerAdded(ChannelHandlerContext ctx) {
    ...
    if (this.serverConfig.decoderConfig().withUTF8Validator() && cp.get(Utf8FrameValidator.class) == null)
      cp.addBefore(ctx.name(), Utf8FrameValidator.class.getName(), (ChannelHandler)new Utf8FrameValidator(this.serverConfig
            .decoderConfig().closeOnProtocolViolation())); 
  }
