...
public class WebSocketClientHandshaker00 extends WebSocketClientHandshaker {
  ...
  protected FullHttpRequest newHandshakeRequest() {
    ...
    URI wsURL = uri();
    DefaultFullHttpRequest defaultFullHttpRequest = new DefaultFullHttpRequest(HttpVersion.HTTP_1_1, HttpMethod.GET, upgradeUrl(wsURL), Unpooled.wrappedBuffer(key3));
    ...
    headers.set((CharSequence)HttpHeaderNames.UPGRADE, HttpHeaderValues.WEBSOCKET)
      ...
      .set((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_KEY1, key1)
      .set((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_KEY2, key2);
    if (this.generateOriginHeader && !headers.contains((CharSequence)HttpHeaderNames.ORIGIN))
      headers.set((CharSequence)HttpHeaderNames.ORIGIN, websocketOriginValue(wsURL)); 
