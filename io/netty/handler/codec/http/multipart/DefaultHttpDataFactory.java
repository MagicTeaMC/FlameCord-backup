...
public class DefaultHttpDataFactory implements HttpDataFactory {
  ...
  public Attribute createAttribute(HttpRequest request, String name) {
    if (this.useDisk) {
      Attribute attribute1 = new DiskAttribute(name, this.charset, this.baseDir, this.deleteOnExit);
    ...
    if (this.checkSize) {
      Attribute attribute1 = new MixedAttribute(name, this.minSize, this.charset, this.baseDir, this.deleteOnExit);
      attribute1.setMaxSize(this.maxSize);
      List<HttpData> list = getList(request);
      list.add(attribute1);
      return attribute1;
  ...
  public Attribute createAttribute(HttpRequest request, String name, long definedSize) {
    if (this.useDisk) {
      Attribute attribute1 = new DiskAttribute(name, definedSize, this.charset, this.baseDir, this.deleteOnExit);
      attribute1.setMaxSize(this.maxSize);
      List<HttpData> list = getList(request);
      list.add(attribute1);
      return attribute1;
    ...
    if (this.checkSize) {
      Attribute attribute1 = new MixedAttribute(name, definedSize, this.minSize, this.charset, this.baseDir, this.deleteOnExit);
      attribute1.setMaxSize(this.maxSize);
      List<HttpData> list = getList(request);
      list.add(attribute1);
      return attribute1;
  ...
  public FileUpload createFileUpload(HttpRequest request, String name, String filename, String contentType, String contentTransferEncoding, Charset charset, long size) {
    if (this.useDisk) {
      FileUpload fileUpload1 = new DiskFileUpload(name, filename, contentType, contentTransferEncoding, charset, size, this.baseDir, this.deleteOnExit);
    ...
    if (this.checkSize) {
      FileUpload fileUpload1 = new MixedFileUpload(name, filename, contentType, contentTransferEncoding, charset, size, this.minSize, this.baseDir, this.deleteOnExit);
      fileUpload1.setMaxSize(this.maxSize);
      checkHttpDataSize(fileUpload1);
      List<HttpData> list = getList(request);
      list.add(fileUpload1);
