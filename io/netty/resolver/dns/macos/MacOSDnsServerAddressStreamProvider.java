...
public final class MacOSDnsServerAddressStreamProvider implements DnsServerAddressStreamProvider {
  ...
  static {
    ClassInitializerUtil.tryLoadClasses(MacOSDnsServerAddressStreamProvider.class, new Class[] { byte[].class, String.class });
  ...
  public DnsServerAddressStream nameServerAddressStream(String hostname) {
    ...
    while (true) {
      ...
      if (i < 0 || i == hostname.length() - 1) {
        DnsServerAddresses dnsServerAddresses = resolverMap.get("");
