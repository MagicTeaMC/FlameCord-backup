...
public final class DefaultHostsFileEntriesResolver implements HostsFileEntriesResolver {
  ...
  public List<InetAddress> addresses(String inetHost, ResolvedAddressTypes resolvedAddressTypes) {
    ...
    switch (resolvedAddressTypes) {
      ...
      case IPV4_PREFERRED:
        allInet4Addresses = this.inet4Entries.get(normalized);
        return (allInet4Addresses != null) ? allAddresses(allInet4Addresses, this.inet6Entries.get(normalized)) : this.inet6Entries
          .get(normalized);
      case IPV6_PREFERRED:
        allInet6Addresses = this.inet6Entries.get(normalized);
        return (allInet6Addresses != null) ? allAddresses(allInet6Addresses, this.inet4Entries.get(normalized)) : this.inet4Entries
          .get(normalized);
    } 
