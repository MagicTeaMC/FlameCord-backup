...
public class PooledByteBufAllocator extends AbstractByteBufAllocator implements ByteBufAllocatorMetricProvider {
  ...
  private final class PoolThreadLocalCache extends FastThreadLocal<PoolArenasCache> {
    ...
    protected synchronized PoolArenasCache initialValue() {
      ...
      if ((PooledByteBufAllocator.this.smallCacheSize != 0 || PooledByteBufAllocator.this.normalCacheSize != 0) && (this.useCacheForAllThreads || current instanceof io.netty.util.concurrent.FastThreadLocalThread || executor != null)) {
        ...
        if (PooledByteBufAllocator.DEFAULT_CACHE_TRIM_INTERVAL_MILLIS > 0L && 
          executor != null)
          executor.scheduleAtFixedRate(PooledByteBufAllocator.this.trimTask, PooledByteBufAllocator.DEFAULT_CACHE_TRIM_INTERVAL_MILLIS, PooledByteBufAllocator
  ...
  public final long pinnedHeapMemory() {
    return pinnedMemory((PoolArena<?>[])this.heapArenas);
  }
  
  public final long pinnedDirectMemory() {
    return pinnedMemory((PoolArena<?>[])this.directArenas);
  }
  ...
  public boolean trimCurrentThreadCache() {
    PoolArenasCache cache = (PoolArenasCache)this.threadCache.getIfExists();
    if (cache != null) {
      cache.trim();
      return true;
    } 
