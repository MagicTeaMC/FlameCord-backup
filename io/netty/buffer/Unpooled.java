...
public final class Unpooled {
  ...
  public static ByteBuf wrappedBuffer(int maxNumComponents, byte[]... arrays) {
    return wrappedBuffer(maxNumComponents, (CompositeByteBuf.ByteWrapper)CompositeByteBuf.BYTE_ARRAY_WRAPPER, arrays);
  }
  ...
  private static ByteBuf wrappedUnmodifiableBuffer(boolean copy, ByteBuf... buffers) {
    ...
    if (copy)
      buffers = Arrays.<ByteBuf, ByteBuf>copyOf(buffers, buffers.length, ByteBuf[].class); 
