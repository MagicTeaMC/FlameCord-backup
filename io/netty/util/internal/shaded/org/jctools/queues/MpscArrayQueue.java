...
public class MpscArrayQueue<E> extends MpscArrayQueueL3Pad<E> {
  ...
  public boolean offerIfBelowThreshold(E e, int threshold) {
    ...
    UnsafeRefArrayAccess.soRefElement((Object[])this.buffer, offset, e);
    return true;
  }
  ...
  public E poll() {
    ...
    E e = (E)UnsafeRefArrayAccess.lvRefElement((Object[])buffer, offset);
    if (null == e)
      if (cIndex != lvProducerIndex()) {
        do {
          e = (E)UnsafeRefArrayAccess.lvRefElement((Object[])buffer, offset);
        } while (e == null);
      } else {
        return null;
      }  
    UnsafeRefArrayAccess.spRefElement((Object[])buffer, offset, null);
  ...
  public E relaxedPeek() {
    ...
    long mask = this.mask;
    long cIndex = lpConsumerIndex();
    return (E)UnsafeRefArrayAccess.lvRefElement((Object[])buffer, UnsafeRefArrayAccess.calcCircularRefElementOffset(cIndex, mask));
  }
