...
final class CleanerJava6 implements Cleaner {
  ...
  static {
    ...
    try {
      Object cleaner, mayBeCleanerField = AccessController.doPrivileged(new PrivilegedAction() {
            public Object run() {
              try {
  ...
  private static void freeDirectBufferPrivileged(final ByteBuffer buffer) {
    Throwable cause = AccessController.<Throwable>doPrivileged(new PrivilegedAction<Throwable>() {
