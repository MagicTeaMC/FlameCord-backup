...
public class DefaultChannelGroup extends AbstractSet<Channel> implements ChannelGroup {
  ...
  public boolean add(Channel channel) {
    ConcurrentMap<ChannelId, Channel> map = (channel instanceof io.netty.channel.ServerChannel) ? this.serverChannels : this.nonServerChannels;
  ...
  public ChannelGroupFuture write(Object message, ChannelMatcher matcher, boolean voidPromise) {
    ...
    if (voidPromise) {
      ...
      Map<Channel, ChannelFuture> futures = new LinkedHashMap<Channel, ChannelFuture>(this.nonServerChannels.size());
      for (Channel c : this.nonServerChannels.values()) {
        if (matcher.matches(c))
