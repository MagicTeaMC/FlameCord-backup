...
public class TObjectFloatCustomHashMap<K> extends TCustomObjectHash<K> implements TObjectFloatMap<K>, Externalizable {
  ...
  public boolean equals(Object other) {
    ...
    if (that.size() != size())
      return false; 
    try {
      TObjectFloatIterator<K> iter = iterator();
      while (iter.hasNext()) {
        iter.advance();
        Object key = iter.key();
  ...
  protected class KeyView extends MapBackedView<K> {
    public Iterator<K> iterator() {
      return (Iterator<K>)new TObjectHashIterator((TObjectHash)TObjectFloatCustomHashMap.this);
    }
  ...
  class TFloatValueCollection implements TFloatCollection {
    ...
    class TObjectFloatValueHashIterator implements TFloatIterator {
      protected THash _hash = (THash)TObjectFloatCustomHashMap.this;
