...
public class TFloatLongHashMap extends TFloatLongHash implements TFloatLongMap, Externalizable {
  ...
  protected class TKeyView implements TFloatSet {
    public TFloatIterator iterator() {
      return new TFloatLongHashMap.TFloatLongKeyHashIterator((TPrimitiveHash)TFloatLongHashMap.this);
    }
  ...
  protected class TValueView implements TLongCollection {
    public TLongIterator iterator() {
      return new TFloatLongHashMap.TFloatLongValueHashIterator((TPrimitiveHash)TFloatLongHashMap.this);
    }
