...
public abstract class CoreSession implements Session {
  ...
  public ProfilerEventHandler getProfilerEventHandler() {
    if (this.eventSink == null)
      synchronized (this) {
        if (this.eventSink == null) {
          this.eventSink = (ProfilerEventHandler)Util.getInstance(ProfilerEventHandler.class, this.propertySet
              .getStringProperty(PropertyKey.profilerEventHandler).getStringValue(), null, null, this.exceptionInterceptor);
