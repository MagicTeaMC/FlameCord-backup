...
public final class SequenceGroup extends Sequence {
  private static final AtomicReferenceFieldUpdater<SequenceGroup, Sequence[]> SEQUENCE_UPDATER = (AtomicReferenceFieldUpdater)AtomicReferenceFieldUpdater.newUpdater(SequenceGroup.class, (Class)Sequence[].class, "sequences");
  ...
  public void addWhileRunning(Cursored cursored, Sequence sequence) {
    SequenceGroups.addSequences(this, SEQUENCE_UPDATER, cursored, new Sequence[] { sequence });
  }
}
