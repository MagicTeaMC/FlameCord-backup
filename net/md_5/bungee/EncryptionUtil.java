...
public class EncryptionUtil {
  ...
  public static final NativeCode<BungeeCipher> nativeFactory = new NativeCode("native-cipher", net.md_5.bungee.jni.cipher.JavaCipher::new, net.md_5.bungee.jni.cipher.NativeCipher::new);
  ...
  static {
    ...
    } catch (IOException|NoSuchAlgorithmException|java.security.spec.InvalidKeySpecException ex) {
      throw new ExceptionInInitializerError(ex);
    } 
  }
  ...
  public static BungeeCipher getCipher(boolean forEncryption, SecretKey shared) throws GeneralSecurityException {
    BungeeCipher cipher = (BungeeCipher)nativeFactory.newInstance();
