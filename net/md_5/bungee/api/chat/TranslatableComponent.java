...
public final class TranslatableComponent extends BaseComponent {
  ...
  public String toString() {
    return "TranslatableComponent(format=" + getFormat() + ", translate=" + getTranslate() + ", with=" + getWith() + ", fallback=" + getFallback() + ")";
  }
  ...
  public boolean equals(Object o) {
    ...
    if ((this$with == null) ? (other$with != null) : !this$with.equals(other$with))
      return false; 
    Object this$fallback = getFallback(), other$fallback = other.getFallback();
  ...
  public int hashCode() {
    ...
    return result * 59 + (($fallback == null) ? 43 : $fallback.hashCode());
  }
