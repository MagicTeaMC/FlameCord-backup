...
public abstract class BaseComponent {
  ...
  public String toString() {
    return "BaseComponent(color=" + getColor() + ", font=" + getFont() + ", bold=" + this.bold + ", italic=" + this.italic + ", underlined=" + this.underlined + ", strikethrough=" + this.strikethrough + ", obfuscated=" + this.obfuscated + ", insertion=" + getInsertion() + ", extra=" + getExtra() + ", clickEvent=" + getClickEvent() + ", hoverEvent=" + getHoverEvent() + ", reset=" + isReset() + ")";
  }
